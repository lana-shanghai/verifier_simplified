...
pub mod verifier {
	...
	impl<T: Config> Pallet<T> {
        ...
        pub fn verify_match(origin:OriginFor<T>, bid_uuid:u32, bid_market_uuid:Vec<u8>, bid_asset_uuid:Vec<u8>, bid_max_energy:u32, bid_time_slot:Vec<u8>,
        ...
        pub fn verify_matches_of_bids_and_offers(origin:OriginFor<T>, list_of_bids:Vec<Bid>, list_of_offers:Vec<Offer>, matches:Vec<Match>) -> DispatchResult {
